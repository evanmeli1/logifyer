...
const BALLOONS: Array<{
  ...
  { key: 'joy', title: 'Warmth', subtitle: 'Joyful / Affectionate', grad: ['#FBBF24', '#FDE68A'] },
...
const styles = StyleSheet.create({
  ...
  balloonTitle: { fontSize: 14, fontFamily: 'Inter_700Bold', marginBottom: 4, letterSpacing: -0.2 },
  balloonSubtitle: { fontSize: 12, fontFamily: 'Inter_600SemiBold', lineHeight: 16 },
  ...
  emptyTitle: { fontSize: 22, fontFamily: 'Inter_700Bold', marginBottom: 6, textAlign: 'center', letterSpacing: -0.3 },
  emptySubtitle: { fontSize: 15, fontFamily: 'Inter_500Medium', textAlign: 'center', marginBottom: 26, lineHeight: 22, maxWidth: 260 },
  ...
  emptyButtonText: { color: '#FFFFFF', fontSize: 17, fontFamily: 'Inter_700Bold', letterSpacing: -0.3 },
});
