...
export default function LogIncidentScreen({ route }: any) {
  ...
  const fromPersonDetail = route.params?.fromPersonDetail; // ADD THIS
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontFamily: 'Inter_700Bold', color: '#FFF', letterSpacing: -0.3 },  menuBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.2)', justifyContent: 'center', alignItems: 'center' },
